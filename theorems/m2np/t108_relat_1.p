fof(t108_relat_1, conjecture,  (! [A] :  (! [B] :  (v1_relat_1(B) =>  (! [C] :  (v1_relat_1(C) => k6_relat_1(A, k3_relat_1(B, C))=k3_relat_1(B, k6_relat_1(A, C))) ) ) ) ) ).
...
fof(t92_relat_1, axiom,  (! [A] :  (! [B] :  (v1_relat_1(B) => k6_relat_1(A, B)=k3_relat_1(B, k4_relat_1(A))) ) ) ).
