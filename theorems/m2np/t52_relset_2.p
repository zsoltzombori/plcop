fof(t52_relset_2, conjecture,  (! [A] :  (! [B] :  (! [C] :  (! [D] :  (m1_subset_1(D, k1_zfmisc_1(k2_zfmisc_1(A, B))) =>  (! [E] :  (m1_subset_1(E, k1_zfmisc_1(k2_zfmisc_1(B, C))) =>  (k10_xtuple_0(k7_relset_2(A, B, C, D, E))=k7_relset_1(B, C, E, k10_xtuple_0(D)) & r1_tarski(k10_xtuple_0(k7_relset_2(A, B, C, D, E)), k10_xtuple_0(E))) ) ) ) ) ) ) ) ).
