fof(t11_relset_1, conjecture,  (! [A] :  (! [B] :  (! [C] :  (m1_subset_1(C, k1_zfmisc_1(k2_zfmisc_1(A, B))) =>  (k1_relset_1(B, k3_relset_1(A, B, C))=k2_relset_1(B, C) & k2_relset_1(A, k3_relset_1(A, B, C))=k1_relset_1(A, C)) ) ) ) ) ).
