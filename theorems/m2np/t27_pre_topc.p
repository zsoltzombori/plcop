...
fof(t68_funct_1, axiom,  (! [A] :  (! [B] :  (! [C] :  ( (v1_relat_1(C) & v1_funct_1(C))  => k8_relat_1(C, k3_xboole_0(A, B))=k3_xboole_0(k8_relat_1(C, A), k8_relat_1(C, B))) ) ) ) ).
