fof(t27_partfun1, conjecture,  (! [A] :  (! [B] :  (! [C] :  ( (v1_relat_1(C) & v1_funct_1(C))  =>  (! [D] :  ( (v1_relat_1(D) & v1_funct_1(D))  =>  (r1_tarski(C, D) => r1_relset_1(A, B, k3_partfun1(C, A, B), k3_partfun1(D, A, B))) ) ) ) ) ) ) ).
...
fof(t101_relat_1, axiom,  (! [A] :  (! [B] :  (v1_relat_1(B) =>  (! [C] :  (v1_relat_1(C) =>  (r1_tarski(B, C) => r1_tarski(k6_relat_1(A, B), k6_relat_1(A, C))) ) ) ) ) ) ).
fof(t76_relat_1, axiom,  (! [A] :  (! [B] :  (v1_relat_1(B) =>  (! [C] :  (v1_relat_1(C) =>  (r1_tarski(B, C) => r1_tarski(k5_relat_1(B, A), k5_relat_1(C, A))) ) ) ) ) ) ).
