fof(t28_partfun1, conjecture,  (! [A] :  (! [B] :  (! [C] :  (! [D] :  ( (v1_relat_1(D) & v1_funct_1(D))  =>  (r1_tarski(A, B) => r1_relset_1(A, C, k3_partfun1(D, A, C), k3_partfun1(D, B, C))) ) ) ) ) ) ).
...
fof(t75_relat_1, axiom,  (! [A] :  (! [B] :  (! [C] :  (v1_relat_1(C) =>  (r1_tarski(A, B) => r1_tarski(k5_relat_1(C, A), k5_relat_1(C, B))) ) ) ) ) ).
