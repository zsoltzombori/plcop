fof(t36_funct_1, conjecture,  (! [A] :  ( (v1_relat_1(A) & v1_funct_1(A))  =>  (v2_funct_1(A) =>  (k9_xtuple_0(k3_relat_1(A, k2_funct_1(A)))=k9_xtuple_0(A) & k10_xtuple_0(k3_relat_1(A, k2_funct_1(A)))=k9_xtuple_0(A)) ) ) ) ).
