fof(t29_funct_2, conjecture,  (! [A] :  (! [B] :  (! [C] :  ( (v1_funct_1(C) &  (v1_funct_2(C, A, B) & m1_subset_1(C, k1_zfmisc_1(k2_zfmisc_1(A, B)))) )  =>  ( (k2_relset_1(B, C)=B & v2_funct_1(C))  =>  (B=k1_xboole_0 |  (k3_relat_1(C, k2_funct_1(C))=k6_partfun1(A) & k3_relat_1(k2_funct_1(C), C)=k6_partfun1(B)) ) ) ) ) ) ) ).
