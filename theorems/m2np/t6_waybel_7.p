fof(t6_waybel_7, conjecture,  (! [A] :  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(k3_yellow_1(A)))) =>  (v12_waybel_0(B, k3_yellow_1(A)) <=>  (! [C] :  (! [D] :  ( (r1_tarski(C, D) & r2_hidden(D, B))  => r2_hidden(C, B)) ) ) ) ) ) ) ).
