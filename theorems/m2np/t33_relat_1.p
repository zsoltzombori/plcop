fof(t33_relat_1, conjecture,  (! [A] :  (v1_relat_1(A) =>  (! [B] :  (v1_relat_1(B) =>  (! [C] :  (v1_relat_1(C) => r1_tarski(k3_relat_1(A, k3_xboole_0(B, C)), k3_xboole_0(k3_relat_1(A, B), k3_relat_1(A, C)))) ) ) ) ) ) ).
