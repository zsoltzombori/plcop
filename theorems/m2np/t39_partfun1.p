fof(t39_partfun1, conjecture,  (! [A] :  (! [B] :  (! [C] :  (! [D] :  ( (v1_relat_1(D) & v1_funct_1(D))  => k6_relset_1(B, C, A, k3_partfun1(D, B, C))=k3_partfun1(D, B, k3_xboole_0(A, C))) ) ) ) ) ).
...
fof(t109_relat_1, axiom,  (! [A] :  (! [B] :  (! [C] :  (v1_relat_1(C) => k5_relat_1(k6_relat_1(A, C), B)=k6_relat_1(A, k5_relat_1(C, B))) ) ) ) ).
fof(t96_relat_1, axiom,  (! [A] :  (! [B] :  (! [C] :  (v1_relat_1(C) => k6_relat_1(A, k6_relat_1(B, C))=k6_relat_1(k3_xboole_0(A, B), C)) ) ) ) ).
