fof(t25_funct_1, conjecture,  (! [A] :  ( (v1_relat_1(A) & v1_funct_1(A))  =>  (! [B] :  ( (v1_relat_1(B) & v1_funct_1(B))  =>  ( (v2_funct_1(k3_relat_1(B, A)) & r1_tarski(k10_xtuple_0(B), k9_xtuple_0(A)))  => v2_funct_1(B)) ) ) ) ) ).
