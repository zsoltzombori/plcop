%------------------------------------------------------------------------------
% File     : relat_1__t88_relat_1

% Syntax   : Number of formulae    :   36 (  17 unit)
%            Number of atoms       :   67 (   5 equality)
%            Maximal formula depth :   11 (   4 average)
%            Number of connectives :   44 (  13 ~  ;   1  |;  12  &)
%                                         (   4 <=>;  14 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :    7 (   1 propositional; 0-2 arity)
%            Number of functors    :    6 (   1 constant; 0-2 arity)
%            Number of variables   :   55 (   1 singleton;  48 !;   7 ?)
