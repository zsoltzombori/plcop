%------------------------------------------------------------------------------
% File     : yellow19__t4_yellow19

% Syntax   : Number of formulae    :  254 (  22 unit)
%            Number of atoms       : 1461 (  37 equality)
%            Maximal formula depth :   36 (   7 average)
%            Number of connectives : 1438 ( 231 ~  ;   1  |; 913  &)
%                                         (   5 <=>; 288 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :  134 (   1 propositional; 0-3 arity)
%            Number of functors    :   22 (   1 constant; 0-4 arity)
%            Number of variables   :  459 (   1 singleton; 361 !;  98 ?)
