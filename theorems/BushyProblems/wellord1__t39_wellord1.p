%------------------------------------------------------------------------------
% File     : wellord1__t39_wellord1

% Syntax   : Number of formulae    :   57 (  26 unit)
%            Number of atoms       :  119 (  14 equality)
%            Maximal formula depth :    8 (   4 average)
%            Number of connectives :   73 (  11 ~  ;   1  |;  31  &)
%                                         (   7 <=>;  23 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :   18 (   1 propositional; 0-2 arity)
%            Number of functors    :   12 (   1 constant; 0-2 arity)
%            Number of variables   :   80 (   3 singleton;  72 !;   8 ?)
