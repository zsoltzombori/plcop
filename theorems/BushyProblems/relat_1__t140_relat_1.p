%------------------------------------------------------------------------------
% File     : relat_1__t140_relat_1

% Syntax   : Number of formulae    :   38 (  17 unit)
%            Number of atoms       :   75 (   8 equality)
%            Maximal formula depth :   11 (   4 average)
%            Number of connectives :   50 (  13 ~  ;   1  |;  13  &)
%                                         (   7 <=>;  16 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :    7 (   1 propositional; 0-2 arity)
%            Number of functors    :    7 (   1 constant; 0-2 arity)
%            Number of variables   :   63 (   1 singleton;  56 !;   7 ?)
