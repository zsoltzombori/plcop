%------------------------------------------------------------------------------
% File     : tops_1__t44_tops_1

% Syntax   : Number of formulae    :   80 (  10 unit)
%            Number of atoms       :  252 (  15 equality)
%            Maximal formula depth :   11 (   5 average)
%            Number of connectives :  199 (  27 ~  ;   1  |;  90  &)
%                                         (   2 <=>;  79 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :   27 (   1 propositional; 0-2 arity)
%            Number of functors    :   11 (   1 constant; 0-2 arity)
%            Number of variables   :  131 (   1 singleton; 112 !;  19 ?)
