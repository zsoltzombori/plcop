%------------------------------------------------------------------------------
% File     : yellow_1__t4_yellow_1

% Syntax   : Number of formulae    :  217 (  46 unit)
%            Number of atoms       :  937 (  65 equality)
%            Maximal formula depth :   18 (   6 average)
%            Number of connectives :  854 ( 134 ~  ;   1  |; 536  &)
%                                         (   7 <=>; 176 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :   75 (   1 propositional; 0-3 arity)
%            Number of functors    :   37 (   1 constant; 0-3 arity)
%            Number of variables   :  345 (   3 singleton; 287 !;  58 ?)
