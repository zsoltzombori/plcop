%------------------------------------------------------------------------------
% File     : yellow19__t15_yellow19

% Syntax   : Number of formulae    :  258 (  27 unit)
%            Number of atoms       : 1459 (  41 equality)
%            Maximal formula depth :   36 (   7 average)
%            Number of connectives : 1427 ( 226 ~  ;   1  |; 918  &)
%                                         (   5 <=>; 277 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :  133 (   1 propositional; 0-3 arity)
%            Number of functors    :   24 (   1 constant; 0-4 arity)
%            Number of variables   :  451 (   1 singleton; 354 !;  97 ?)
