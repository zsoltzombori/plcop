%------------------------------------------------------------------------------
% File     : funct_1__t22_funct_1

% Syntax   : Number of formulae    :   48 (  19 unit)
%            Number of atoms       :  111 (  10 equality)
%            Maximal formula depth :   13 (   4 average)
%            Number of connectives :   79 (  16 ~  ;   1  |;  31  &)
%                                         (   7 <=>;  24 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :    9 (   1 propositional; 0-2 arity)
%            Number of functors    :    8 (   1 constant; 0-2 arity)
%            Number of variables   :   71 (   1 singleton;  60 !;  11 ?)
