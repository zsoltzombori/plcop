%------------------------------------------------------------------------------
% File     : yellow19__t11_yellow19

% Syntax   : Number of formulae    :  240 (  22 unit)
%            Number of atoms       : 1370 (  36 equality)
%            Maximal formula depth :   36 (   7 average)
%            Number of connectives : 1332 ( 202 ~  ;   1  |; 861  &)
%                                         (   4 <=>; 264 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :  133 (   1 propositional; 0-3 arity)
%            Number of functors    :   21 (   1 constant; 0-4 arity)
%            Number of variables   :  419 (   1 singleton; 322 !;  97 ?)
