%------------------------------------------------------------------------------
% File     : waybel_0__t8_waybel_0

% Syntax   : Number of formulae    :  124 (  22 unit)
%            Number of atoms       :  529 (  26 equality)
%            Maximal formula depth :   18 (   6 average)
%            Number of connectives :  501 (  96 ~  ;   1  |; 271  &)
%                                         (   2 <=>; 131 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :   70 (   1 propositional; 0-3 arity)
%            Number of functors    :   17 (   1 constant; 0-4 arity)
%            Number of variables   :  227 (   1 singleton; 186 !;  41 ?)
