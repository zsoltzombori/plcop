%------------------------------------------------------------------------------
% File     : tops_1__t51_tops_1

% Syntax   : Number of formulae    :   75 (  10 unit)
%            Number of atoms       :  231 (  15 equality)
%            Maximal formula depth :    9 (   5 average)
%            Number of connectives :  173 (  17 ~  ;   1  |;  83  &)
%                                         (   1 <=>;  71 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :   27 (   1 propositional; 0-2 arity)
%            Number of functors    :   11 (   1 constant; 0-2 arity)
%            Number of variables   :  119 (   1 singleton; 100 !;  19 ?)
