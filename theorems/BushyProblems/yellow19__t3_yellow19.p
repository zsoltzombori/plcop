%------------------------------------------------------------------------------
% File     : yellow19__t3_yellow19

% Syntax   : Number of formulae    :  242 (  22 unit)
%            Number of atoms       : 1378 (  36 equality)
%            Maximal formula depth :   36 (   7 average)
%            Number of connectives : 1336 ( 200 ~  ;   1  |; 864  &)
%                                         (   4 <=>; 267 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :  133 (   1 propositional; 0-3 arity)
%            Number of functors    :   21 (   1 constant; 0-4 arity)
%            Number of variables   :  425 (   1 singleton; 327 !;  98 ?)
