%------------------------------------------------------------------------------
% File     : yellow19__t2_yellow19

% Syntax   : Number of formulae    :  228 (  23 unit)
%            Number of atoms       : 1324 (  34 equality)
%            Maximal formula depth :   36 (   7 average)
%            Number of connectives : 1283 ( 187 ~  ;   1  |; 842  &)
%                                         (   2 <=>; 251 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :  131 (   1 propositional; 0-3 arity)
%            Number of functors    :   19 (   1 constant; 0-4 arity)
%            Number of variables   :  401 (   1 singleton; 305 !;  96 ?)
