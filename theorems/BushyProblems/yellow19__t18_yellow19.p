%------------------------------------------------------------------------------
% File     : yellow19__t18_yellow19

% Syntax   : Number of formulae    :  249 (  22 unit)
%            Number of atoms       : 1463 (  37 equality)
%            Maximal formula depth :   36 (   7 average)
%            Number of connectives : 1446 ( 232 ~  ;   1  |; 932  &)
%                                         (   4 <=>; 277 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :  135 (   1 propositional; 0-3 arity)
%            Number of functors    :   23 (   1 constant; 0-4 arity)
%            Number of variables   :  441 (   1 singleton; 344 !;  97 ?)
