%------------------------------------------------------------------------------
% File     : pre_topc__t12_pre_topc

% Syntax   : Number of formulae    :   63 (  11 unit)
%            Number of atoms       :  176 (  15 equality)
%            Maximal formula depth :    9 (   4 average)
%            Number of connectives :  129 (  16 ~  ;   1  |;  58  &)
%                                         (   1 <=>;  53 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :   24 (   1 propositional; 0-2 arity)
%            Number of functors    :    9 (   1 constant; 0-2 arity)
%            Number of variables   :   91 (   1 singleton;  77 !;  14 ?)
