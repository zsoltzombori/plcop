% Mizar problem: t48_tops_2,tops_2,801,35 
fof(t48_tops_2, conjecture,  (! [A] :  (l1_pre_topc(A) =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  (! [C] :  (m1_subset_1(C, k1_zfmisc_1(k1_zfmisc_1(u1_struct_0(A)))) =>  (v2_tops_2(C, A) => v2_tops_2(k1_tops_2(A, B, C), k1_pre_topc(A, B))) ) ) ) ) ) ) ).
