% Mizar problem: t14_waybel_9,waybel_9,772,54 
fof(t14_waybel_9, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  & l1_struct_0(A))  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  & l1_waybel_0(B, A))  =>  (! [C] :  (m1_subset_1(C, u1_struct_0(B)) =>  (v2_yellow_6(k4_waybel_9(A, B, C), A, B) & m1_yellow_6(k4_waybel_9(A, B, C), A, B)) ) ) ) ) ) ) ).
