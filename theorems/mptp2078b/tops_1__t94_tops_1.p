% Mizar problem: t94_tops_1,tops_1,1307,52 
fof(t94_tops_1, conjecture,  (! [A] :  (l1_pre_topc(A) =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  (v4_pre_topc(B, A) =>  (v3_tops_1(B, A) <=> B=k2_tops_1(A, B)) ) ) ) ) ) ).
