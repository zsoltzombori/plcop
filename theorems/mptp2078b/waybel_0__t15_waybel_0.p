% Mizar problem: t15_waybel_0,waybel_0,1000,70 
fof(t15_waybel_0, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  & l1_orders_2(A))  =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) => k4_waybel_0(A, B)=a_2_1_waybel_0(A, B)) ) ) ) ).
