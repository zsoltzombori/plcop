% Mizar problem: t19_connsp_2,connsp_2,368,16 
fof(t19_connsp_2, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (r1_connsp_2(A, B) <=>  (! [C] :  (m1_subset_1(C, k1_zfmisc_1(u1_struct_0(A))) =>  (! [D] :  (m1_subset_1(D, k1_zfmisc_1(u1_struct_0(A))) =>  ( (m1_connsp_2(C, A, B) &  (r3_connsp_1(A, C, D) & r2_hidden(B, D)) )  => m1_connsp_2(D, A, B)) ) ) ) ) ) ) ) ) ) ).
