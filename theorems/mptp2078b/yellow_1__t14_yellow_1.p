% Mizar problem: t14_yellow_1,yellow_1,590,75 
fof(t14_yellow_1, conjecture,  (! [A] :  ( ~ (v1_xboole_0(A))  =>  (r2_hidden(k3_tarski(A), A) => k4_yellow_0(k2_yellow_1(A))=k3_tarski(A)) ) ) ).
...
fof(t43_yellow_0, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v5_orders_2(A) &  (v2_yellow_0(A) & l1_orders_2(A)) ) )  =>  (r2_yellow_0(A, k1_xboole_0) & r1_yellow_0(A, u1_struct_0(A))) ) ) ).
