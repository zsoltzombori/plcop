% Mizar problem: t97_xboole_1,xboole_1,1317,49 
fof(t97_xboole_1, conjecture,  (! [A] :  (! [B] :  (! [C] :  ( (r1_tarski(k4_xboole_0(A, B), C) & r1_tarski(k4_xboole_0(B, A), C))  => r1_tarski(k5_xboole_0(A, B), C)) ) ) ) ).
