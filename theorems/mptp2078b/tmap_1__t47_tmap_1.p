% Mizar problem: t47_tmap_1,tmap_1,1431,57 
fof(t47_tmap_1, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  &  (v2_pre_topc(B) & l1_pre_topc(B)) )  =>  (! [C] :  ( (v1_funct_1(C) &  (v1_funct_2(C, u1_struct_0(B), u1_struct_0(A)) & m1_subset_1(C, k1_zfmisc_1(k2_zfmisc_1(u1_struct_0(B), u1_struct_0(A))))) )  =>  (! [D] :  (m1_subset_1(D, u1_struct_0(B)) =>  (r1_tmap_1(B, A, C, D) <=>  (! [E] :  (m1_connsp_2(E, A, k3_funct_2(u1_struct_0(B), u1_struct_0(A), C, D)) => m1_connsp_2(k8_relset_1(u1_struct_0(B), u1_struct_0(A), C, E), B, D)) ) ) ) ) ) ) ) ) ) ) ).
