% Mizar problem: t29_yellow_6,yellow_6,839,30 
fof(t29_yellow_6, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  & l1_struct_0(A))  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  &  (v4_orders_2(B) &  (v7_waybel_0(B) & l1_waybel_0(B, A)) ) )  => r1_waybel_0(A, B, u1_struct_0(A))) ) ) ) ).
