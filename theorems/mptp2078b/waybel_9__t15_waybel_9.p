% Mizar problem: t15_waybel_9,waybel_9,939,7 
fof(t15_waybel_9, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  & l1_struct_0(A))  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  &  (v3_orders_2(B) & l1_waybel_0(B, A)) )  =>  (! [C] :  (m1_subset_1(C, u1_struct_0(B)) =>  (! [D] :  (m1_subset_1(D, u1_struct_0(B)) =>  (! [E] :  (m1_subset_1(E, u1_struct_0(k4_waybel_9(A, B, C))) =>  (D=E => k2_waybel_0(A, B, D)=k2_waybel_0(A, k4_waybel_9(A, B, C), E)) ) ) ) ) ) ) ) ) ) ) ).
