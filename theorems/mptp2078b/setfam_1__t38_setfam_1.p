% Mizar problem: t38_setfam_1,setfam_1,752,56 
fof(t38_setfam_1, conjecture,  (! [A] :  (! [B] :  ( ~ (B=k1_xboole_0)  => k6_subset_1(A, k1_setfam_1(B))=k3_tarski(k4_setfam_1(k1_tarski(A), B))) ) ) ).
