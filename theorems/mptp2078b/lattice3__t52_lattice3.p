% Mizar problem: t52_lattice3,lattice3,2009,48 
fof(t52_lattice3, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) &  (v4_lattice3(A) & l3_lattices(A)) ) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (! [C] :  (m1_subset_1(C, u1_struct_0(A)) =>  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) &  (v3_filter_0(A) & l3_lattices(A)) ) )  => k4_filter_0(A, B, C)=k15_lattice3(A, a_3_6_lattice3(A, B, C))) ) ) ) ) ) ) ).
