% Mizar problem: t24_connsp_2,connsp_2,579,72 
fof(t24_connsp_2, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (v1_connsp_2(A) <=>  (! [B] :  ( ( ~ (v1_xboole_0(B))  & m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))))  =>  (! [C] :  (m1_subset_1(C, k1_zfmisc_1(u1_struct_0(A))) =>  ( (v3_pre_topc(B, A) & r3_connsp_1(A, B, C))  => v3_pre_topc(C, A)) ) ) ) ) ) ) ) ).
...
fof(d6_connsp_2, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  ( ( ~ (v1_xboole_0(B))  & m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))))  =>  (v2_connsp_2(B, A) <=> v1_connsp_2(k1_pre_topc(A, B))) ) ) ) ) ).
...
fof(t20_connsp_2, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (r1_connsp_2(A, B) <=>  (! [C] :  ( ( ~ (v1_xboole_0(C))  & m1_subset_1(C, k1_zfmisc_1(u1_struct_0(A))))  =>  ~ ( (v3_pre_topc(C, A) &  (r2_hidden(B, C) &  (! [D] :  (m1_subset_1(D, u1_struct_0(k1_pre_topc(A, C))) =>  ~ ( (D=B & r2_hidden(B, k1_tops_1(k1_pre_topc(A, C), k1_connsp_1(k1_pre_topc(A, C), D)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ).
fof(t21_connsp_2, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (v1_connsp_2(A) =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  (v3_connsp_1(B, A) => v3_pre_topc(B, A)) ) ) ) ) ) ).
fof(t23_connsp_2, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (v1_connsp_2(A) =>  (! [B] :  ( ( ~ (v1_xboole_0(B))  & m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))))  =>  (v3_pre_topc(B, A) => v2_connsp_2(B, A)) ) ) ) ) ) ).
