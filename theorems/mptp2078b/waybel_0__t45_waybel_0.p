% Mizar problem: t45_waybel_0,waybel_0,1970,71 
fof(t45_waybel_0, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v5_orders_2(A) & l1_orders_2(A)) )  =>  ( (v1_lattice3(A) | v2_lattice3(A))  =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  (! [C] :  (m1_subset_1(C, k1_zfmisc_1(u1_struct_0(A))) =>  ( (v13_waybel_0(B, A) &  (v2_waybel_0(B, A) &  (v13_waybel_0(C, A) & v2_waybel_0(C, A)) ) )  => v2_waybel_0(k9_subset_1(u1_struct_0(A), B, C), A)) ) ) ) ) ) ) ) ).
...
fof(t29_waybel_0, axiom,  (! [A] :  (l1_orders_2(A) =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  (! [C] :  (m1_subset_1(C, k1_zfmisc_1(u1_struct_0(A))) =>  ( (v13_waybel_0(B, A) & v13_waybel_0(C, A))  =>  (v13_waybel_0(k9_subset_1(u1_struct_0(A), B, C), A) & v13_waybel_0(k4_subset_1(u1_struct_0(A), B, C), A)) ) ) ) ) ) ) ) ).
