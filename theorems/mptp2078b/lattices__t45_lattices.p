% Mizar problem: t45_lattices,lattices,733,60 
fof(t45_lattices, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) &  (v14_lattices(A) & l3_lattices(A)) ) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) => r3_lattices(A, B, k6_lattices(A))) ) ) ) ).
