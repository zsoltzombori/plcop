% Mizar problem: t29_lattice3,lattice3,1415,23 
fof(t29_lattice3, conjecture,  (! [A] :  (! [B] :  ( ( ~ (v2_struct_0(B))  &  (v10_lattices(B) & l3_lattices(B)) )  =>  (! [C] :  (m1_subset_1(C, u1_struct_0(k3_lattice3(B))) =>  (r1_lattice3(k3_lattice3(B), A, C) <=> r3_lattice3(B, k5_lattice3(B, C), A)) ) ) ) ) ) ).
