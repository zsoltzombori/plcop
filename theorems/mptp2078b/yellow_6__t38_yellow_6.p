% Mizar problem: t38_yellow_6,yellow_6,1518,6 
fof(t38_yellow_6, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (! [C] :  (m1_subset_1(C, u1_struct_0(k9_yellow_6(A, B))) =>  (? [D] :  (m1_subset_1(D, k1_zfmisc_1(u1_struct_0(A))) &  (D=C &  (r2_hidden(B, D) & v3_pre_topc(D, A)) ) ) ) ) ) ) ) ) ) ).
