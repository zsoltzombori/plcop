% Mizar problem: t16_tex_2,tex_2,350,43 
fof(t16_tex_2, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  & l1_pre_topc(A))  =>  (! [B] :  ( ( ~ (v1_tex_2(B, A))  & m1_pre_topc(B, A))  => g1_pre_topc(u1_struct_0(B), u1_pre_topc(B))=g1_pre_topc(u1_struct_0(A), u1_pre_topc(A))) ) ) ) ).
