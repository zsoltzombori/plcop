% Mizar problem: t42_yellow_0,yellow_0,1256,40 
fof(t42_yellow_0, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v5_orders_2(A) &  (v1_yellow_0(A) & l1_orders_2(A)) ) )  =>  (r1_yellow_0(A, k1_xboole_0) & r2_yellow_0(A, u1_struct_0(A))) ) ) ).
