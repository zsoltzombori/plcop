% Mizar problem: t21_tmap_1,tmap_1,580,73 
fof(t21_tmap_1, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  & m1_pre_topc(B, A))  =>  (! [C] :  ( ( ~ (v2_struct_0(C))  & m1_pre_topc(C, A))  =>  (! [D] :  (m1_subset_1(D, u1_struct_0(k1_tsep_1(A, B, C))) =>  (! [E] :  (m1_subset_1(E, u1_struct_0(B)) =>  (! [F] :  (m1_subset_1(F, u1_struct_0(C)) =>  ( (E=D & F=D)  =>  (! [G] :  (m1_connsp_2(G, B, E) =>  (! [H] :  (m1_connsp_2(H, C, F) =>  (? [I] :  (m1_connsp_2(I, k1_tsep_1(A, B, C), D) & r1_tarski(I, k2_xboole_0(G, H))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).
...
fof(t20_tmap_1, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  & m1_pre_topc(B, A))  =>  (! [C] :  ( ( ~ (v2_struct_0(C))  & m1_pre_topc(C, A))  =>  (! [D] :  (m1_subset_1(D, u1_struct_0(k1_tsep_1(A, B, C))) =>  (! [E] :  (m1_subset_1(E, u1_struct_0(B)) =>  (! [F] :  (m1_subset_1(F, u1_struct_0(C)) =>  ( (E=D & F=D)  =>  (! [G] :  (m1_connsp_2(G, B, E) =>  (! [H] :  (m1_connsp_2(H, C, F) =>  (? [I] :  (m1_subset_1(I, k1_zfmisc_1(u1_struct_0(k1_tsep_1(A, B, C)))) &  (v3_pre_topc(I, k1_tsep_1(A, B, C)) &  (r2_hidden(D, I) & r1_tarski(I, k2_xboole_0(G, H))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).
