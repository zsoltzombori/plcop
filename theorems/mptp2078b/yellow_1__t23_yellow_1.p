% Mizar problem: t23_yellow_1,yellow_1,810,7 
fof(t23_yellow_1, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  => k3_yellow_0(k2_yellow_1(u1_pre_topc(A)))=k1_xboole_0) ) ).
