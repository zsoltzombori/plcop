% Mizar problem: t14_tex_2,tex_2,269,47 
fof(t14_tex_2, conjecture,  (! [A] :  (l1_pre_topc(A) =>  (! [B] :  (m1_pre_topc(B, A) =>  (! [C] :  (m1_pre_topc(C, A) =>  ( (g1_pre_topc(u1_struct_0(B), u1_pre_topc(B))=g1_pre_topc(u1_struct_0(C), u1_pre_topc(C)) & v1_tex_2(B, A))  => v1_tex_2(C, A)) ) ) ) ) ) ) ).
