% Mizar problem: t25_connsp_2,connsp_2,634,47 
fof(t25_connsp_2, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (v1_connsp_2(A) =>  (! [B] :  ( ( ~ (v1_xboole_0(B))  & m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))))  =>  (! [C] :  ( ( ~ (v1_xboole_0(C))  & m1_subset_1(C, k1_zfmisc_1(u1_struct_0(k1_pre_topc(A, B)))))  =>  ~ ( (v2_connsp_1(C, k1_pre_topc(A, B)) &  (v3_pre_topc(C, k1_pre_topc(A, B)) &  (! [D] :  (m1_subset_1(D, k1_zfmisc_1(u1_struct_0(A))) =>  ~ ( (v3_pre_topc(D, A) &  (v2_connsp_1(D, A) & C=k9_subset_1(u1_struct_0(A), B, D)) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).
