% Mizar problem: t76_tops_1,tops_1,870,25 
fof(t76_tops_1, conjecture,  (! [A] :  ( (v2_pre_topc(A) & l1_pre_topc(A))  =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  (v3_pre_topc(B, A) <=> k2_tops_1(A, B)=k7_subset_1(u1_struct_0(A), k2_pre_topc(A, B), B)) ) ) ) ) ).
...
fof(l82_tops_1, axiom,  (! [A] :  (! [B] :  (! [C] :  ( (r1_tarski(A, C) & B=k6_subset_1(C, A))  => r1_tarski(A, k6_subset_1(C, B))) ) ) ) ).
...
fof(t74_tops_1, axiom,  (! [A] :  (l1_pre_topc(A) =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) => k1_tops_1(A, B)=k7_subset_1(u1_struct_0(A), B, k2_tops_1(A, B))) ) ) ) ).
