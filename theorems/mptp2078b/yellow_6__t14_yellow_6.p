% Mizar problem: t14_yellow_6,yellow_6,492,58 
fof(t14_yellow_6, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  & l1_orders_2(A))  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  & l1_struct_0(B))  =>  (! [C] :  (m1_subset_1(C, u1_struct_0(B)) =>  (! [D] :  (m1_subset_1(D, u1_struct_0(k3_yellow_6(A, B, C))) => k2_waybel_0(B, k3_yellow_6(A, B, C), D)=C) ) ) ) ) ) ) ) ).
