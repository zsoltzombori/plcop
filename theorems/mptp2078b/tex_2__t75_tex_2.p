% Mizar problem: t75_tex_2,tex_2,2653,20 
fof(t75_tex_2, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) &  (v3_tdlat_3(A) & l1_pre_topc(A)) ) )  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  &  (v4_tex_2(B, A) & m1_pre_topc(B, A)) )  => r1_borsuk_1(A, B)) ) ) ) ).
