% Mizar problem: t24_yellow19,yellow19,1000,31 
fof(t24_yellow19, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  (! [C] :  (m1_subset_1(C, u1_struct_0(A)) =>  (r2_hidden(C, k2_pre_topc(A, B)) <=>  (? [D] :  ( ( ~ (v2_struct_0(D))  &  (v4_orders_2(D) &  (v7_waybel_0(D) &  (v3_yellow_6(D, A) & l1_waybel_0(D, A)) ) ) )  &  (r1_waybel_0(A, D, B) & r2_hidden(C, k10_yellow_6(A, D))) ) ) ) ) ) ) ) ) ) ).
