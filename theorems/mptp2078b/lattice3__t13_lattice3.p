% Mizar problem: t13_lattice3,lattice3,769,22 
fof(t13_lattice3, conjecture,  (! [A] :  ( (v5_orders_2(A) &  (v1_lattice3(A) & l1_orders_2(A)) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (! [C] :  (m1_subset_1(C, u1_struct_0(A)) => k10_lattice3(A, B, C)=k10_lattice3(A, C, B)) ) ) ) ) ) ).
