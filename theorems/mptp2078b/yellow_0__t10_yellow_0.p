% Mizar problem: t10_yellow_0,yellow_0,366,42 
fof(t10_yellow_0, conjecture,  (! [A] :  (l1_orders_2(A) =>  (! [B] :  (! [C] :  (! [D] :  (m1_subset_1(D, u1_struct_0(A)) =>  ( ( (r1_lattice3(A, B, D) & r1_lattice3(A, C, D))  => r1_lattice3(A, k2_xboole_0(B, C), D))  &  ( (r2_lattice3(A, B, D) & r2_lattice3(A, C, D))  => r2_lattice3(A, k2_xboole_0(B, C), D)) ) ) ) ) ) ) ) ).
