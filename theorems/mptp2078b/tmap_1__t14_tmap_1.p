% Mizar problem: t14_tmap_1,tmap_1,414,44 
fof(t14_tmap_1, conjecture,  (! [A] :  ( (v2_pre_topc(A) & l1_pre_topc(A))  =>  (! [B] :  ( (v2_pre_topc(B) & l1_pre_topc(B))  =>  (! [C] :  ( (v2_pre_topc(C) & l1_pre_topc(C))  =>  (C=g1_pre_topc(u1_struct_0(B), u1_pre_topc(B)) =>  ( (v1_tsep_1(B, A) & m1_pre_topc(B, A))  <=>  (v1_tsep_1(C, A) & m1_pre_topc(C, A)) ) ) ) ) ) ) ) ) ).
...
fof(rc1_tsep_1, axiom,  (! [A] :  ( (v2_pre_topc(A) & l1_pre_topc(A))  =>  (? [B] :  (m1_pre_topc(B, A) &  (v1_pre_topc(B) &  (v2_pre_topc(B) & v1_tsep_1(B, A)) ) ) ) ) ) ).
