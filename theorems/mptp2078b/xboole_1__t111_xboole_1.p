% Mizar problem: t111_xboole_1,xboole_1,1432,28 
fof(t111_xboole_1, conjecture,  (! [A] :  (! [B] :  (! [C] : k4_xboole_0(k3_xboole_0(A, B), k3_xboole_0(C, B))=k3_xboole_0(k4_xboole_0(A, C), B)) ) ) ).
