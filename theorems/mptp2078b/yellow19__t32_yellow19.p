% Mizar problem: t32_yellow19,yellow19,1238,36 
fof(t32_yellow19, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(k1_zfmisc_1(u1_struct_0(A)))) =>  (v2_tops_2(B, A) => v2_tops_2(k2_cantor_1(u1_struct_0(A), B), A)) ) ) ) ) ).
