...
fof(t87_tsep_1, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  ( (v1_borsuk_1(B, A) & m1_pre_topc(B, A))  =>  (! [C] :  ( (v1_borsuk_1(C, A) & m1_pre_topc(C, A))  => r4_tsep_1(A, B, C)) ) ) ) ) ) ).
