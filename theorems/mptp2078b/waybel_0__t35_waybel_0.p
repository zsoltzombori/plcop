% Mizar problem: t35_waybel_0,waybel_0,1626,41 
fof(t35_waybel_0, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v3_orders_2(A) &  (v4_orders_2(A) & l1_orders_2(A)) ) )  =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  (v2_waybel_0(B, A) <=> v2_waybel_0(k4_waybel_0(A, B), A)) ) ) ) ) ).
