% Mizar problem: t55_waybel_0,waybel_0,2454,61 
fof(t55_waybel_0, conjecture,  (! [A] :  ( (v3_orders_2(A) &  (v4_orders_2(A) &  (v5_orders_2(A) &  (v1_lattice3(A) & l1_orders_2(A)) ) ) )  =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  ( (r1_yellow_0(A, B) | v3_lattice3(A))  => k1_yellow_0(A, B)=k1_yellow_0(A, k11_waybel_0(A, B))) ) ) ) ) ).
