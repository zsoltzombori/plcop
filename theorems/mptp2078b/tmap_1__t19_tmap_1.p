% Mizar problem: t19_tmap_1,tmap_1,523,58 
fof(t19_tmap_1, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  & m1_pre_topc(B, A))  =>  (! [C] :  ( ( ~ (v2_struct_0(C))  & m1_pre_topc(C, A))  =>  (! [D] :  (m1_subset_1(D, u1_struct_0(k1_tsep_1(A, B, C))) =>  (! [E] :  (m1_subset_1(E, k1_zfmisc_1(u1_struct_0(B))) =>  (! [F] :  (m1_subset_1(F, k1_zfmisc_1(u1_struct_0(C))) =>  ~ ( (v3_pre_topc(E, B) &  (r2_hidden(D, E) &  (v3_pre_topc(F, C) &  (r2_hidden(D, F) &  (! [G] :  (m1_subset_1(G, k1_zfmisc_1(u1_struct_0(k1_tsep_1(A, B, C)))) =>  ~ ( (v3_pre_topc(G, k1_tsep_1(A, B, C)) &  (r2_hidden(D, G) & r1_tarski(G, k2_xboole_0(E, F))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).
