% Mizar problem: t47_lattice3,lattice3,1868,44 
fof(t47_lattice3, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) &  (v4_lattice3(A) & l3_lattices(A)) ) )  =>  (! [B] :  (k15_lattice3(A, B)=k15_lattice3(A, a_2_5_lattice3(A, B)) & k16_lattice3(A, B)=k16_lattice3(A, a_2_6_lattice3(A, B))) ) ) ) ).
