% Mizar problem: t36_yellow_0,yellow_0,1141,19 
fof(t36_yellow_0, conjecture,  (! [A] :  ( (v4_orders_2(A) &  (v5_orders_2(A) & l1_orders_2(A)) )  =>  (! [B] :  (! [C] :  ( (r1_yellow_0(A, B) &  (r1_yellow_0(A, C) & r1_yellow_0(A, k2_xboole_0(B, C))) )  => k1_yellow_0(A, k2_xboole_0(B, C))=k10_lattice3(A, k1_yellow_0(A, B), k1_yellow_0(A, C))) ) ) ) ) ).
