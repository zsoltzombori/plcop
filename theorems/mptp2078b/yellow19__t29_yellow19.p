% Mizar problem: t29_yellow19,yellow19,1139,45 
fof(t29_yellow19, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  (v4_pre_topc(B, A) <=>  (! [C] :  ( ( ~ (v1_xboole_0(C))  &  (v1_subset_1(C, u1_struct_0(k3_yellow_1(k2_struct_0(A)))) &  (v2_waybel_0(C, k3_yellow_1(k2_struct_0(A))) &  (v13_waybel_0(C, k3_yellow_1(k2_struct_0(A))) & m1_subset_1(C, k1_zfmisc_1(u1_struct_0(k3_yellow_1(k2_struct_0(A)))))) ) ) )  =>  (r2_hidden(B, C) =>  (! [D] :  (m1_subset_1(D, u1_struct_0(A)) =>  (r1_waybel_7(A, C, D) => r2_hidden(D, B)) ) ) ) ) ) ) ) ) ) ) ).
