% Mizar problem: t69_yellow_0,yellow_0,2149,18 
fof(t69_yellow_0, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v3_orders_2(A) &  (v4_orders_2(A) &  (v5_orders_2(A) &  (v3_lattice3(A) & l1_orders_2(A)) ) ) ) )  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  &  (v4_yellow_0(B, A) & m1_yellow_0(B, A)) )  =>  (! [C] :  (m1_subset_1(C, k1_zfmisc_1(u1_struct_0(B))) =>  (r2_hidden(k1_yellow_0(A, C), u1_struct_0(B)) => k1_yellow_0(B, C)=k1_yellow_0(A, C)) ) ) ) ) ) ) ).
