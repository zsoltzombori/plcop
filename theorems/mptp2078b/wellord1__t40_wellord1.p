% Mizar problem: t40_wellord1,wellord1,803,58 
fof(t40_wellord1, conjecture,  (! [A] :  (! [B] :  (v1_relat_1(B) =>  (v2_wellord1(B) => k3_relat_1(k2_wellord1(B, k1_wellord1(B, A)))=k1_wellord1(B, A)) ) ) ) ).
