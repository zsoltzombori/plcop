% Mizar problem: t21_tex_2,tex_2,534,33 
fof(t21_tex_2, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  & l1_pre_topc(A))  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  ~ ( (v1_tex_2(k1_tex_2(A, B), A) & v7_struct_0(A)) ) ) ) ) ) ).
