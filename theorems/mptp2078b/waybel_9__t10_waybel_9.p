% Mizar problem: t10_waybel_9,waybel_9,355,28 
fof(t10_waybel_9, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  & l1_orders_2(A))  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (! [C] :  ( ( ~ (v2_struct_0(C))  &  (v4_orders_2(C) &  (v7_waybel_0(C) & l1_waybel_0(C, A)) ) )  =>  ( ~ (v2_struct_0(k3_waybel_2(A, B, C)))  &  (v4_orders_2(k3_waybel_2(A, B, C)) &  (v7_waybel_0(k3_waybel_2(A, B, C)) & l1_waybel_0(k3_waybel_2(A, B, C), A)) ) ) ) ) ) ) ) ) ).
...
fof(t22_waybel_2, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  & l1_orders_2(A))  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  & l1_waybel_0(B, A))  =>  (! [C] :  (m1_subset_1(C, u1_struct_0(A)) =>  (! [D] :  (m1_subset_1(D, u1_struct_0(B)) <=> m1_subset_1(D, u1_struct_0(k3_waybel_2(A, C, B)))) ) ) ) ) ) ) ) ).
