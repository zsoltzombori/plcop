% Mizar problem: t40_yellow_6,yellow_6,1549,54 
fof(t40_yellow_6, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (! [C] :  (m1_subset_1(C, u1_struct_0(k9_yellow_6(A, B))) =>  (! [D] :  (m1_subset_1(D, u1_struct_0(k9_yellow_6(A, B))) =>  (r1_orders_2(k9_yellow_6(A, B), C, D) <=> r1_tarski(D, C)) ) ) ) ) ) ) ) ) ).
