% Mizar problem: t88_orders_2,orders_2,1560,74 
fof(t88_orders_2, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v3_orders_2(A) &  (v4_orders_2(A) &  (v5_orders_2(A) & l1_orders_2(A)) ) ) )  =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  (! [C] :  (m1_orders_1(C, k1_orders_1(u1_struct_0(A))) =>  (! [D] :  (m2_orders_2(D, A, C) =>  (B=k3_tarski(k4_orders_2(A, C)) =>  (D=k3_tarski(k4_orders_2(A, C)) | m1_orders_2(D, A, B)) ) ) ) ) ) ) ) ) ) ).
