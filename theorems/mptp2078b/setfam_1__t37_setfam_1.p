% Mizar problem: t37_setfam_1,setfam_1,704,55 
fof(t37_setfam_1, conjecture,  (! [A] :  (! [B] :  ( ~ (B=k1_xboole_0)  => k6_subset_1(A, k3_tarski(B))=k1_setfam_1(k4_setfam_1(k1_tarski(A), B))) ) ) ).
