% Mizar problem: t47_tops_2,tops_2,785,31 
fof(t47_tops_2, conjecture,  (! [A] :  (l1_pre_topc(A) =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  (! [C] :  (m1_subset_1(C, k1_zfmisc_1(k1_zfmisc_1(u1_struct_0(A)))) =>  (v1_tops_2(C, A) => v1_tops_2(k1_tops_2(A, B, C), k1_pre_topc(A, B))) ) ) ) ) ) ) ).
