...
fof(dt_o_1_3_filter_1, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) &  (v15_lattices(A) & l3_lattices(A)) ) )  => m1_subset_1(o_1_3_filter_1(A), u1_struct_0(A))) ) ).
