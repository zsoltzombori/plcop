% Mizar problem: t117_xboole_1,xboole_1,1494,67 
fof(t117_xboole_1, conjecture,  (! [A] :  (! [B] :  (! [C] :  (r1_tarski(C, B) => k4_xboole_0(A, C)=k2_xboole_0(k4_xboole_0(A, B), k3_xboole_0(A, k4_xboole_0(B, C)))) ) ) ) ).
