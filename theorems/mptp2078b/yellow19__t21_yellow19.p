% Mizar problem: t21_yellow19,yellow19,919,74 
fof(t21_yellow19, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  & l1_struct_0(A))  =>  (! [B] :  (! [C] :  ( ( ~ (v2_struct_0(C))  &  (v4_orders_2(C) &  (v7_waybel_0(C) & l1_waybel_0(C, A)) ) )  =>  (r1_waybel_0(A, C, B) =>  (! [D] :  (m2_yellow_6(D, A, C) => r1_waybel_0(A, D, B)) ) ) ) ) ) ) ) ).
