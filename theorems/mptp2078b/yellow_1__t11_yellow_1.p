% Mizar problem: t11_yellow_1,yellow_1,489,46 
fof(t11_yellow_1, conjecture,  (! [A] :  ( ~ (v1_xboole_0(A))  =>  ( (! [B] :  (! [C] :  ( (r2_hidden(B, A) & r2_hidden(C, A))  => r2_hidden(k2_xboole_0(B, C), A)) ) )  => v1_lattice3(k2_yellow_1(A))) ) ) ).
