% Mizar problem: t12_connsp_2,connsp_2,269,62 
fof(t12_connsp_2, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  ( ( ~ (v1_xboole_0(B))  & m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))))  =>  (! [C] :  (m1_subset_1(C, u1_struct_0(k1_pre_topc(A, B))) =>  (! [D] :  (m1_subset_1(D, k1_zfmisc_1(u1_struct_0(k1_pre_topc(A, B)))) =>  (! [E] :  (m1_subset_1(E, k1_zfmisc_1(u1_struct_0(A))) =>  (! [F] :  (m1_subset_1(F, u1_struct_0(A)) =>  ( (m1_connsp_2(E, A, F) &  (D=E & C=F) )  => m1_connsp_2(D, k1_pre_topc(A, B), C)) ) ) ) ) ) ) ) ) ) ) ) ) ).
