% Mizar problem: t43_filter_1,filter_1,1716,19 
fof(t43_filter_1, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) & l3_lattices(A)) )  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  &  (v10_lattices(B) & l3_lattices(B)) )  =>  ( ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) &  (v13_lattices(A) & l3_lattices(A)) ) )  &  ( ~ (v2_struct_0(B))  &  (v10_lattices(B) &  (v13_lattices(B) & l3_lattices(B)) ) ) )  => k5_lattices(k7_filter_1(A, B))=k9_filter_1(A, B, k5_lattices(A), k5_lattices(B))) ) ) ) ) ).
