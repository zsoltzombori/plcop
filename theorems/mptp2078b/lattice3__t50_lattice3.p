% Mizar problem: t50_lattice3,lattice3,1974,37 
fof(t50_lattice3, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) &  (v4_lattice3(A) & l3_lattices(A)) ) )  =>  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) &  (v13_lattices(A) & l3_lattices(A)) ) )  & k5_lattices(A)=k15_lattice3(A, k1_xboole_0)) ) ) ).
