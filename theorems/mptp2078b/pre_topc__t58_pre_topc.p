% Mizar problem: t58_pre_topc,pre_topc,1318,18 
fof(t58_pre_topc, conjecture,  (! [A] :  (l1_pre_topc(A) =>  (v2_pre_topc(g1_pre_topc(u1_struct_0(A), u1_pre_topc(A))) => v2_pre_topc(A)) ) ) ).
