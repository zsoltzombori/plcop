% Mizar problem: t12_tex_2,tex_2,222,58 
fof(t12_tex_2, conjecture,  (! [A] :  (l1_pre_topc(A) =>  (! [B] :  (l1_pre_topc(B) =>  ( (g1_pre_topc(u1_struct_0(A), u1_pre_topc(A))=g1_pre_topc(u1_struct_0(B), u1_pre_topc(B)) & v2_pre_topc(A))  => v2_pre_topc(B)) ) ) ) ) ).
