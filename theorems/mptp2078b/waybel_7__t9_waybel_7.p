% Mizar problem: t9_waybel_7,waybel_7,141,70 
fof(t9_waybel_7, conjecture,  (! [A] :  (! [B] :  (m1_subset_1(B, u1_struct_0(k3_yellow_1(A))) => k7_waybel_1(k3_yellow_1(A), B)=k6_subset_1(A, B)) ) ) ).
