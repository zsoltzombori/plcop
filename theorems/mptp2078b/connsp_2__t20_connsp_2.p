% Mizar problem: t20_connsp_2,connsp_2,430,21 
fof(t20_connsp_2, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (r1_connsp_2(A, B) <=>  (! [C] :  ( ( ~ (v1_xboole_0(C))  & m1_subset_1(C, k1_zfmisc_1(u1_struct_0(A))))  =>  ~ ( (v3_pre_topc(C, A) &  (r2_hidden(B, C) &  (! [D] :  (m1_subset_1(D, u1_struct_0(k1_pre_topc(A, C))) =>  ~ ( (D=B & r2_hidden(B, k1_tops_1(k1_pre_topc(A, C), k1_connsp_1(k1_pre_topc(A, C), D)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ).
...
fof(d3_connsp_2, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (r1_connsp_2(A, B) <=>  (! [C] :  (m1_subset_1(C, k1_zfmisc_1(u1_struct_0(A))) =>  ~ ( (m1_connsp_2(C, A, B) &  (! [D] :  (m1_subset_1(D, k1_zfmisc_1(u1_struct_0(A))) =>  ~ ( (m1_connsp_2(D, A, B) &  (v2_connsp_1(D, A) & r1_tarski(D, C)) ) ) ) ) ) ) ) ) ) ) ) ) ) ).
...
fof(t19_connsp_2, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (r1_connsp_2(A, B) <=>  (! [C] :  (m1_subset_1(C, k1_zfmisc_1(u1_struct_0(A))) =>  (! [D] :  (m1_subset_1(D, k1_zfmisc_1(u1_struct_0(A))) =>  ( (m1_connsp_2(C, A, B) &  (r3_connsp_1(A, C, D) & r2_hidden(B, D)) )  => m1_connsp_2(D, A, B)) ) ) ) ) ) ) ) ) ) ).
