% Mizar problem: t35_lattice3,lattice3,1632,38 
fof(t35_lattice3, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) &  (v4_lattice3(A) & l3_lattices(A)) ) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (! [C] : r3_lattices(A, k3_lattices(A, B, k16_lattice3(A, C)), k16_lattice3(A, a_3_4_lattice3(A, B, C)))) ) ) ) ) ).
