% Mizar problem: t32_lattice3,lattice3,1535,40 
fof(t32_lattice3, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) &  (v4_lattice3(A) & l3_lattices(A)) ) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (! [C] : r3_lattices(A, k15_lattice3(A, a_3_2_lattice3(A, B, C)), k4_lattices(A, B, k15_lattice3(A, C)))) ) ) ) ) ).
