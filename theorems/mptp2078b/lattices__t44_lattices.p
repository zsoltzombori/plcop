% Mizar problem: t44_lattices,lattices,730,4 
fof(t44_lattices, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) &  (v14_lattices(A) & l3_lattices(A)) ) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) => k3_lattices(A, k6_lattices(A), B)=k6_lattices(A)) ) ) ) ).
