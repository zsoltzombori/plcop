% Mizar problem: t51_lattice3,lattice3,1994,43 
fof(t51_lattice3, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) &  (v4_lattice3(A) & l3_lattices(A)) ) )  =>  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) &  (v14_lattices(A) & l3_lattices(A)) ) )  & k6_lattices(A)=k15_lattice3(A, u1_struct_0(A))) ) ) ).
