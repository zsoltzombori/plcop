% Mizar problem: t33_waybel_9,waybel_9,1841,40 
fof(t33_waybel_9, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) &  (v8_pre_topc(A) &  (v1_compts_1(A) & l1_pre_topc(A)) ) ) )  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  &  (v4_orders_2(B) &  (v7_waybel_0(B) & l1_waybel_0(B, A)) ) )  =>  ( (! [C] :  (m1_subset_1(C, u1_struct_0(A)) =>  (! [D] :  (m1_subset_1(D, u1_struct_0(A)) =>  ( (r3_waybel_9(A, B, C) & r3_waybel_9(A, B, D))  => C=D) ) ) ) )  =>  (! [C] :  (m1_subset_1(C, u1_struct_0(A)) =>  (r3_waybel_9(A, B, C) => r2_hidden(C, k10_yellow_6(A, B))) ) ) ) ) ) ) ) ).
...
fof(t46_yellow_6, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  &  (v4_orders_2(B) &  (v7_waybel_0(B) & l1_waybel_0(B, A)) ) )  =>  (! [C] :  (m1_subset_1(C, u1_struct_0(A)) =>  ~ ( ( ~ (r2_hidden(C, k10_yellow_6(A, B)))  &  (! [D] :  (m2_yellow_6(D, A, B) =>  (? [E] :  (m2_yellow_6(E, A, D) & r2_hidden(C, k10_yellow_6(A, E))) ) ) ) ) ) ) ) ) ) ) ) ).
