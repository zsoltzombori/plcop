% Mizar problem: t26_lattice3,lattice3,1221,32 
fof(t26_lattice3, conjecture,  (! [A] : v5_lattice3(k1_lattice3(A))) ).
...
fof(fraenkel_a_3_12_lattice3, axiom,  (! [A, B, C, D] :  (m1_subset_1(D, u1_struct_0(k1_lattice3(B))) =>  (r2_hidden(A, a_3_12_lattice3(B, C, D)) <=>  (? [E] :  (m1_subset_1(E, u1_struct_0(k1_lattice3(B))) &  (A=k2_lattices(k1_lattice3(B), D, E) & r2_hidden(E, C)) ) ) ) ) ) ).
fof(fraenkel_a_3_13_lattice3, axiom,  (! [A, B, C, D] :  (m1_subset_1(D, u1_struct_0(k1_lattice3(B))) =>  (r2_hidden(A, a_3_13_lattice3(B, C, D)) <=>  (? [E] :  (m1_subset_1(E, u1_struct_0(k1_lattice3(B))) &  (A=k4_lattices(k1_lattice3(B), D, E) & r2_hidden(E, C)) ) ) ) ) ) ).
