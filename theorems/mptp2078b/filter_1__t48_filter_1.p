% Mizar problem: t48_filter_1,filter_1,1867,68 
fof(t48_filter_1, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) & l3_lattices(A)) )  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  &  (v10_lattices(B) & l3_lattices(B)) )  =>  ( (v3_filter_0(A) & v3_filter_0(B))  <=> v3_filter_0(k7_filter_1(A, B))) ) ) ) ) ).
...
fof(d7_filter_0, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  & l3_lattices(A))  =>  (v3_filter_0(A) <=>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (! [C] :  (m1_subset_1(C, u1_struct_0(A)) =>  (? [D] :  (m1_subset_1(D, u1_struct_0(A)) &  (r1_lattices(A, k2_lattices(A, B, D), C) &  (! [E] :  (m1_subset_1(E, u1_struct_0(A)) =>  (r1_lattices(A, k2_lattices(A, B, E), C) => r1_lattices(A, E, D)) ) ) ) ) ) ) ) ) ) ) ) ) ).
