% Mizar problem: t26_yellow_0,yellow_0,921,53 
fof(t26_yellow_0, conjecture,  (! [A] :  (l1_orders_2(A) =>  (! [B] :  (l1_orders_2(B) =>  (g1_orders_2(u1_struct_0(A), u1_orders_2(A))=g1_orders_2(u1_struct_0(B), u1_orders_2(B)) =>  (! [C] :  (r1_yellow_0(A, C) => k1_yellow_0(A, C)=k1_yellow_0(B, C)) ) ) ) ) ) ) ).
