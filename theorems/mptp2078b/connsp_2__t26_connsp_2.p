% Mizar problem: t26_connsp_2,connsp_2,686,8 
fof(t26_connsp_2, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v2_pre_topc(A) & l1_pre_topc(A)) )  =>  (v10_pre_topc(A) <=>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  (! [C] :  (m1_subset_1(C, k1_zfmisc_1(u1_struct_0(A))) =>  ~ ( ( ~ (B=k1_xboole_0)  &  ( ~ (C=k2_struct_0(A))  &  (r1_tarski(B, C) &  (v4_pre_topc(B, A) &  (v3_pre_topc(C, A) &  (! [D] :  (m1_subset_1(D, k1_zfmisc_1(u1_struct_0(A))) =>  ~ ( (v3_pre_topc(D, A) &  (r1_tarski(B, D) & r1_tarski(k2_pre_topc(A, D), C)) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).
