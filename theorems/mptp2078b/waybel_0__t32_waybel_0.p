% Mizar problem: t32_waybel_0,waybel_0,1595,39 
fof(t32_waybel_0, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v3_orders_2(A) &  (v4_orders_2(A) & l1_orders_2(A)) ) )  =>  (! [B] :  (m1_subset_1(B, k1_zfmisc_1(u1_struct_0(A))) =>  (r1_yellow_0(A, B) <=> r1_yellow_0(A, k3_waybel_0(A, B))) ) ) ) ) ).
