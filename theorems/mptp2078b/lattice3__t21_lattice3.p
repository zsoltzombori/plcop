% Mizar problem: t21_lattice3,lattice3,1054,37 
fof(t21_lattice3, conjecture,  (! [A] :  ( ( ~ (v2_struct_0(A))  &  (v10_lattices(A) & l3_lattices(A)) )  =>  (! [B] :  (m1_subset_1(B, u1_struct_0(A)) =>  (! [C] :  (m1_subset_1(C, u1_struct_0(A)) =>  (! [D] :  (m1_subset_1(D, u1_struct_0(A)) =>  (r3_lattice3(A, B, k7_domain_1(u1_struct_0(A), C, D)) <=> r3_lattices(A, B, k4_lattices(A, C, D))) ) ) ) ) ) ) ) ) ).
